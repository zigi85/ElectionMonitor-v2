...
הקשר לוח זמנים:
- הבחירות הכלליות לכנסת ב-27.10.2026. אם התאריך היום רחוק מהבחירות, זינוק בחיפושים או באזכורים לא בהכרח קשור לבחירות הכלליות.
- חשוב על מה באמת יכול לגרום לזינוק: פריימריז פנימיים, ועידת מפלגה, סקר חדש, אירוע ביטחוני, שערורייה, ראיון תקשורתי, חקירה פלילית.
- אם כותרות התקשורת מזכירות נושא ספציפי (פריימריז, ועידה, פרשה) — ציין אותו. אל תכתוב "רגע לפני הבחירות" אם הבחירות עוד חודשיים.
